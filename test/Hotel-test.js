...
describe('Main', () => {
  ...
  it('Should be able to calculate total revenue from rooms for the current day for the current day', () => {
  ...
  it('Should be able to find a customers info from a search', () => {
    ...
    expect(customerObj1.id).to.eql(1);
    expect(customerObj1.name).to.eql('Matilde Larson');
